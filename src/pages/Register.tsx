...
import { Film, ArrowRight, Loader2, Sparkles, MailCheck } from 'lucide-react';
            ...
            {emailSent ? (
              <div className="text-center py-6">
                ...
                <p className="text-muted-foreground mb-6 max-w-sm mx-auto">
                  Hemos enviado un enlace de confirmación a <span className="font-medium text-foreground">{email}</span>. Confirma tu cuenta antes de continuar.
                </p>
                <Button
                  variant="outline"
